...
const
  ...
  _INSERT_OP = 'INSERT INTO operacoes (cliente, nroperacao, remessa, tipooperacao, datavencto, valornominal, condnegociais, garantiasreais)';
var
...
//        codigoData := IntToStr(Trunc(dataRem - EncodeDate(1997,10,07)));
        ...
        DB_Query.SQL.Add(' VALUES (:cliente, :nroperacao, :remessa, :tipooperacao, :datavencto, :valordivida, :condnegociais, :garantiasreais)');
